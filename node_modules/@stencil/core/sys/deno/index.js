...
function globToRegExp(e, {extended: t = !1, globstar: r = !0} = {}) {
 const n = function o(e, {extended: t = !1, globstar: r = !1, strict: n = !1, filepath: a = !1, flags: i = ""} = {}) {
  ...
  const p = [];
  let g, y;
  for (let o = 0; o < e.length; o++) if (g = e[o], y = e[o + 1], [ "\\", "$", "^", ".", "=" ].includes(g)) s("\\" + g); else if (g.match(l)) s(SEP$1, {
   split: !0
  }), null != y && y.match(l) && !n && (c += "?"); else if ("(" !== g) if (")" !== g) if ("|" !== g) if ("+" !== g) if ("@" === g && t && "(" === y) p.push(g); else if ("!" !== g) if ("?" !== g) if ("[" !== g) if ("]" !== g) if ("{" !== g) if ("}" !== g) if ("," !== g) if ("*" !== g) s(g); else {
   if ("(" === y && t) {
    p.push(g);
    continue;
   }
